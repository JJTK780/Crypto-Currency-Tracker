  ...
  return (
    <Transition appear show={isOpen} as={Fragment}>
      <Dialog className="relative z-50" onClose={() => { }}>
        ...
        <div className="fixed inset-0 text-black dark:text-white">
          <div className="grid min-h-full mx-2 place-items-center">
            ...
            >
              <Dialog.Panel className="flex flex-col items-center w-full max-w-3xl gap-4 p-4 bg-white border rounded-md shadow-sm border-gray-200 dark:bg-black dark:border-gray-800">
                ...
                <table className="w-full max-w-xl overflow-x-auto text-end">
                  <tbody className="text-sm divide-y divide-gray-200 whitespace-nowrap dark:divide-gray-800">
                    <tr>
